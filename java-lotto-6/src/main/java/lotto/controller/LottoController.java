...
public class LottoController {
    ...
    private int getValidBuyingCost(BuyingCost buyingCost) {
        while (true) {
            try {
    ...
    private Lotto getValidWinningNum(WinningNumbers winningNum) {
        while (true) {
            try {
    ...
    private int getValidBonusNum(Lotto lotto, BonusNum bonusNum) {
        while (true) {
            try {
